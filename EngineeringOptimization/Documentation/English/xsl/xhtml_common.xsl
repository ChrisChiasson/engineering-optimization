...
<xsl:template name="site.sidebar">
  <div id="block_2">
	  ...
	  <p><a href="/">Go to this website's root page.</a></p>
        ...
        <!-- SiteSearch Google -->
    <object type="text/html" data="/html/alpha/related_links.html" width="180px" height="150px"/><br/><br/>
    <object type="text/html" data="/html/alpha/adsense.html" width="160px" height="600px"/><br/><br/>
    <object type="text/html" data="/html/alpha/get_firefox_with_google_toolbar.html" width="120px" height="240px"/><br/><br/>
