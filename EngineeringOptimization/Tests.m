...
engineeringoptimization`a:=Module[{stepCount=0,evaluationCount=0},
...
engineeringoptimization`b:=Module[{stepCount=0,evaluationCount=0},
	NMinimize[xpr[1]/.rep[2],Transpose@{xpr[2],xpr[2]-1/1000/.rep[1],
		xpr[2]+1/1000/.rep[1]}/.rep[2],Method->{"AugmentedLagrangeMultiplier",
		"MaximumPenaltyMultiplier"->Infinity,Method->Automatic}]]

engineeringoptimization`c:=Module[{stepCount=0,evaluationCount=0},
...
engineeringoptimization`d:=FindMinimum[(x-10)^2,{x,1},Method->{"Unimodal",
